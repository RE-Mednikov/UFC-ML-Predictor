...
from src.current_model.clean.parsers import parse_date_to_iso
...
from src.current_model.utils.ids import event_id_from_url
...
def main(limit: int | None = 2, force: bool = False) -> pd.DataFrame:
    ...
    html_dir = data_dir / "raw_html" / "events"
