...
from src.current_model.clean.parsers import parse_date_to_iso, parse_float, parse_name_parts, parse_percentage, parse_record
...
from src.current_model.utils.ids import fighter_id_from_url
...
def main(force: bool = False) -> pd.DataFrame:
    ...
    html_dir = data_dir / "raw_html" / "fighters"
